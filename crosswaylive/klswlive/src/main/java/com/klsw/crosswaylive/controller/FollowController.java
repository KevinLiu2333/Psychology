...
import com.klsw.crosswaylive.service.FollowService;
...
public class FollowController extends _BaseContoller {
    ...
    public Ret follow(@RequestParam("userId") Integer userId,
        ...
        try {
            ...
            follow = userService.selectByPrimaryKey(followId);
