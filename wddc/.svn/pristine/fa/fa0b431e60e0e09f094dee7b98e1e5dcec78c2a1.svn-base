...
<div class='container'>
    <h3 id="disable-responsive2" class="page-header">外部链接功能服务</h3>
    <form method="post" id="publishForm" action="${ctx}/fw/saveLink">
        <input type="hidden" name="fwInfo.fwType" value="外部链接功能服务" />
        <input type="hidden" name="fwInfo.fwTypeCode" value="waibu2">
