...
public class DispatchContent {
	 ...
	 * 接口小类
	 */
	public static final String IFSUBTYPE_WSDL = "1";	//WSDL
	public static final String IFSUBTYPE_REST = "2";	//REST
	public static final String IFSUBTYPE_APP = "3";	//应用
	public static final String IFSUBTYPE_TEL = "4";	//开放端口
