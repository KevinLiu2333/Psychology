...
<div class='container'>
    <h3 id="disable-responsive2" class="page-header"> 列表详细信息服务发布</h3>
    <form method="post" id="publishForm" action="${ctx}/fw/saveJiekou4">
        <input type="hidden" name="fwInfo.fwType" value="列表详细信息服务" />
        <input type="hidden" name="fwInfo.fwTypeCode" value="Jiekou5">
