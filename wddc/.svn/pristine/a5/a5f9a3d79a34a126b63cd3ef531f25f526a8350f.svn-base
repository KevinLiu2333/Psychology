...
option = {
    ...
    options: [
        ...
        {
            title: {text: month[5]+'各部门交换状态'+'\n\n总发送量：'+eval(dataFSL[5].join('+'))+'条'+'  总接收量：'+eval(dataJSL[5].join('+'))+'条'},
        ...
        {
            title: {text: month[6]+'各部门交换状态'+'\n\n总发送量：'+eval(dataFSL[6].join('+'))+'条'+'  总接收量：'+eval(dataJSL[6].join('+'))+'条'},
        ...
        {
            title: {text: month[7]+'各部门交换状态'+'\n\n总发送量：'+eval(dataFSL[7].join('+'))+'条'+'  总接收量：'+eval(dataJSL[7].join('+'))+'条'},
        ...
        {
            title: {text: month[8]+'各部门交换状态'+'\n\n总发送量：'+eval(dataFSL[8].join('+'))+'条'+'  总接收量：'+eval(dataJSL[8].join('+'))+'条'},
        ...
        {
            title: {text: month[9]+'各部门交换状态'+'\n\n总发送量：'+eval(dataFSL[9].join('+'))+'条'+'  总接收量：'+eval(dataJSL[9].join('+'))+'条'},
        ...
        {
            title: {text: month[10]+'各部门交换状态'+'\n\n总发送量：'+eval(dataFSL[10].join('+'))+'条'+'  总接收量：'+eval(dataJSL[10].join('+'))+'条'},
        ...
        {
            title: {text: month[11]+'各部门交换状态'+'\n\n总发送量：'+eval(dataFSL[11].join('+'))+'条'+'  总接收量：'+eval(dataJSL[11].join('+'))+'条'},
