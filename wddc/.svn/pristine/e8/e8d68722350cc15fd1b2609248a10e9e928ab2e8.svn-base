...
<div class="main-container" id="main-container">
					    ...
					    <div class="widget-box">
	                       <div class="widget-header widget-header-small" style="background:#fff">
								 <div class="step">
    	                                    ...
    	                                    <span class="steps  action">第二步（选择检测项）</span>
						   ...
						   <div class="col-xs-12" style="padding-top:10px;border:1px solid #dff0d8;"> 
							...
							<div class="col-xs-12" style="padding-top:10px;"> \
							     <div class="col-md-offset-2 col-md-8 center">
						                   ...
						                   <button type="button" class="btn btn-sm btn-success" onclick="toStep3()" align="Left" style="margin-left:50px;">
												下一步
	...
	<script>
		...
		function toStep3(){
			...
			window.location.href='${ctx}/wdac/dataCheck/toCheckStep3?colCfgId='+checkedValue;
		}
	</script>
</body>
</html>