...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <h2 class="page-header" style="margin-top: 5px">邮件发送历史
                ...
                <div class="panel-body">
                    <div class="adv-table">
                        <table  class="display table table-bordered table-striped" id="dynamic-table">
                            ...
                            <tbody>
                            <c:forEach items="${obj.mailLogList}" var="mailLog" varStatus="row" >
                            <tr>
                                <td>${row.index+1}</td>
                                <td>${mailLog.mailSubject}</td>
                                <td>${obj.mailConfig.mailName}</td>
                                <td>${mailLog.toAddress}</td>
                                <td><fmt:formatDate pattern="yyyy/MM/dd" value="${mailLog.sendTime}"/></td>
                                <td>
                                	<a href="${ctx }/suite/mail/toSendHis?mailId=${mail.mailId}">查看详情</a>
                                </td>
                            </tr>
                            </c:forEach>
                            </tbody>
