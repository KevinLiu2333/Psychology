...
<!-- 资源项 -->
	<h4  class="page-header"><i class="ace-icon fa fa-crosshairs green"></i>&nbsp;<b>资源项</b></h4>
		...
		<tr id="dec">
			<td class="label_1" width="20%" style="text-align: center;height: 60px;">资源项名称</td>
			<td class="label_1" width="20%" style="text-align: center;height: 60px;">数据库字段名</td>
		...
		<tr>
			...
			<td class="label_2" width="12%" style="text-align: center;">
				<select name="zyItemList[${row.index }].openType" value="${zyItem.openType }">
					...
					<option value="">--请选择--</option>
					<option value="普遍共享">普遍共享</option> 
					<option value="按需共享">按需共享</option>
