package com.wonders.wddc.tiles.adaptor;
...
import com.wonders.wddc.tiles.adaptor.injector.FilterInjector;
import com.wonders.wddc.tiles.adaptor.injector.PagerInjector;
