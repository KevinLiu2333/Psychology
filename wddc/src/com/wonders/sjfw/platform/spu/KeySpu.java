...
public class KeySpu {
	...
	public String validFwRSConfig(String unitKey,String format,Date startDate,String rsStyle,String rsStructure){
		...
		if(Strings.isNotBlank(rsStyle)){
			if(WddcConstants.RS_STYLE_COMPLEX.equals(rsStyle) || WddcConstants.RS_STYLE_SIMPLE.equals(rsStyle)){
				isOK = true;
			}else{
				isOK = false;
			}
		...
		if(isOK && Strings.isNotBlank(rsStructure)){
			if(WddcConstants.RS_STRUCTUREKEY_VALUE.equals(rsStructure) || WddcConstants.RS_STRUCTURELIST_MAP.equals(rsStructure) 
					||WddcConstants.RS_STRUCTUREMAP_ARRAY.equals(rsStructure) || WddcConstants.RS_STRUCTURESINGLE_RESULT.equals(rsStructure)){
				isOK = true;
			}else{
				isOK = false;
			}
