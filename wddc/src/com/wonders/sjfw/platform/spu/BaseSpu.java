...
public abstract class BaseSpu {
    ...
    public String genResultString(FwParam spuParam,Map<String, Object> jieguoMap,Map<String, Object> resultMap){
 	    ...
 	    //判断结果返回风格
 	    if(Strings.isNotBlank(spuParam.rsStyle) && WddcConstants.RS_STYLE_SIMPLE.equals(spuParam.rsStyle)){
 		    resultString = Json.toJson(jieguoMap.get(WddcConstants.RS_MAP_DATA));
 	    }else{
