...
<%@ include file="title_setting.jsp" %>
...
<table class="tables" width="100%" border="0" align="center" cellspacing="0" >
	<tr>
		<td align="right">
			...
			页&nbsp;<a href="javascript:jumpNo()"><img alt="跳转" title="跳转" width="25" height="25" src="${ctx }/skins/images/go.png"  style=" vertical-align:middle;"></a>
		</td>
	</tr>
</table>
