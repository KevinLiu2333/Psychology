...
<div class='container'>
    <h3 id="disable-responsive2" class="page-header">功能型数据查询服务</h3>
    <form method="post" id="publishForm" action="${ctx}/fw/saveLink">
        <input type="hidden" name="fwInfo.fwType" value="功能型数据查询服务"/>
        <input type="hidden" name="fwInfo.fwTypeCode" value="Chaxun1">
   ...
   <jsp:include page="base.jsp"/>
    ...
    入口URL：<input type="text" name="fwInfo.configUrl" style="width:780px"/>
    </div>
