...
<div class='container'>
    <h3 id="disable-responsive2" class="page-header">GIS(API)服务</h3>
    <form method="post" id="publishForm" action="${ctx}/fw/saveLink">
        <input type="hidden" name="fwInfo.fwType" value="GIS(API)服务"/>
        <input type="hidden" name="fwInfo.fwTypeCode" value="gis">
   ...
   <jsp:include page="base.jsp"/>
    ...
    API入口：<input type="text" name="fwInfo.fwName1" style="width:780px"/>
    </div>
