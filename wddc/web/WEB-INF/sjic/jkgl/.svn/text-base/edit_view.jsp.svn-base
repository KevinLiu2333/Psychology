...
<div class="row">
	...
	<div class="col-md-12 form-group">
		...
		<input id="type1" type="radio"  name="info.type" value="1" custom="${obj.info.type }" onclick="change_wsdl()">WSDL&nbsp;&nbsp;&nbsp;
		<input id="type2" type="radio"  name="info.type" value="2" custom="${obj.info.type }" onclick="change_rest()">REST
	</div>
	<c:if test="${obj.info == null}">
		...
		<div class="col-md-6 form-group">
			...
			<div class="col-md-10">
				<input id="spaceName" class="form-control"  name="info.spaceName" value="${obj.info.spaceName }">
			</div>
		</div>
		<div class="col-md-6 form-group">
			<div  style="float: left;width: 80px;margin-top:5px"> 服务名：</div>
			<div class="col-md-10">
				<input id="serviceName" class="form-control"  name="info.serviceName" value="${obj.info.serviceName }">
			</div>
		</div>
		<div class="col-md-6 form-group">
		...
		<div class="col-md-6 form-group">
			...
			<div class="col-md-10">
				<input id="paramType" class="form-control"  name="info.paramType" value="${obj.info.paramType }">
			</div>
		</div>
	</div>
	</c:if>
