...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<input type="hidden" id="js_ctx" value="${ctx }">
		...
		<div class="container">
			<div class="col-md-12">
				<h2 class="page-header" style="margin-top: 5px">接口管理
       						...
       						<table  class="display table table-bordered table-striped" id="dynamic-table">
       							...
       							<c:forEach items="${obj.list}" var="bo" varStatus="bos">
       								<tr>
       									...
       									<td>
       										<fmt:formatDate value="${bo.info.updateTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
       									</td>
       									<td>
       										<a href="#" onclick="checkUrl('${bo.info.id }')">测试</a>
											<a href="#" onclick="edit('${bo.info.id }')">编辑</a>
											<a href="#" onclick="deleteinfo('${bo.info.id }')">失效</a>
       									</td>
       								</tr>
       							</c:forEach>
       							</tbody>
	...
	<script type="text/javascript">
		...
		function deleteinfo(id){
			if (confirm("确定失效吗？")) {  
		        $.post("${ctx}/sjic/jkgl/deleteInfo",{id:id},function(data){
		        	location.reload();
		        });  
		    } 
		}
		...
		function checkUrl(id){
			$.post("${ctx}/sjic/jkgl/checkUrl",{id:id},function(data){
