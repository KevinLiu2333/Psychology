...
//
//import com.klsw.apiCommon.api.mapper.TbLiveuserMapper;
...
//    @Resource
//    private TbPhoneCaptchaService2 tbPhoneCaptchaService;
//
//    /**
//     * 用于用户注册时获取验证码
//     *
...
//                    teacher.setIsauth(0);
//                    liveTeacherService.insert(teacher);
//                }
//
...
//                TbLiveteacher teacher = liveTeacherService.selectByUserId(liveuser.getId());
