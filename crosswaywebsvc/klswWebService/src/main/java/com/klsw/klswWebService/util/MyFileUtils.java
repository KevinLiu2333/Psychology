...
public class MyFileUtils {
     ...
     * @return 保存结果
     */
    public Ret uploadfile(MultipartFile[] fileList, String fileType, String packagepath,String bucket) {
...
//        packagepath += "/" + df.format(new Date()) + "/";
        ...
        for (MultipartFile multipartFile : fileList) {
            ...
            try {
                ...
                uploadFileToOss(file, fileUrl, bucket);
                file.delete();
                //文件访问相对路径
                //如果为图片，则生成缩略图
                if ("image".equals(fileType)) {
                    ...
                    uploadFileToOss(thumbnail, thumbnailUrl, bucket);
                    thumbnail.delete();
                }
