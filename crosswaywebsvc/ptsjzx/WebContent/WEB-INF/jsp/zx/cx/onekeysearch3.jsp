...
<form action="${ctx}/cx/onekeysearcheList" method="post" style="background:white; height:600px;">
	<img src="${ctx}/skins/images/zhly/3.png" width="100%" height="512" border="0" usemap="#Map" />
	<map name="Map" id="Map">
		<area shape="rect" coords="2,95,1149,123" href="${ctx}/cx/toOneKeySearch1" />
		<area shape="rect" coords="2,123,1149,148" href="${ctx}/cx/toOneKeySearch2" />
		<area shape="rect" coords="2,307,1149,331" href="${ctx}/cx/toOneKeySearch4" />
		<area shape="rect" coords="3,332,1148,355" href="${ctx}/cx/toOneKeySearch5" />
		<area shape="rect" coords="3,332,1148,355" href="${ctx}/cx/toOneKeySearch6" />
	</map>
</form>
</body>
</html>