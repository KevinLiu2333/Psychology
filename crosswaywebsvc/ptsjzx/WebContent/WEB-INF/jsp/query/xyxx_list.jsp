...
<body>
	<form id="queryForm" name="queryForm" action="${ctx }/query/toPeopleXyxx">
...
function view(id){
	var re = window.showModalDialog("${ctx}/query/viewXyxx?id="+id,self,"dialogWidth=910px;dialogHeight=600px;status:no;");
}
</script>
</html>