...
<%
    ...
    // key
    String key = "b9312ef8e7b94ead84ef562c649ce507";
    ...
    try {
        ...
        // 设置调用的方法和方法的命名空间；
        call.setOperationName(new QName(soapaction, "getLicenseInfoToKeweiOA"));
        // 调用方法并传递参数
        String result = (String) call.invoke(new Object[]{key, "上海施耐德", "Json"});
        out.print(result);
