...
<%
    ...
    String url =  rootPath+ "/services/ZfwZACorpInfoService?wsdl";
    // 命名空间
    String soapaction = rootPath + "/services/ZfwZACorpInfoService";
    // key
    String key = "e69d550e50414c30ba5c7c45b3b84623";
    ...
    try {
        ...
        // 设置调用的方法和方法的命名空间；
        call.setOperationName(new QName(soapaction, "getCorpInfoToZFWZA"));
        // 调用方法并传递参数
