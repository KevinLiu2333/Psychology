...
<tbody>
   ...
   <tr>
     ...
     <td class='label_2' align='center' width='30%'>${obj.cfxdrshxym }<td>
   </tr>
   <tr>
     <td class='label_1' align='center' width='20%'>组织机构代码</td>
     <td class='label_2' align='center' width='30%'>${obj.cfxdrzdm }<td>
     <td class='label_1' align='center' width='20%'>工商登记码</td>
     <td class='label_2' align='center' width='30%'>${obj.cfxdrgsdj }<td>
   </tr>
   <tr>
     <td class='label_1' align='center' width='20%'>税务登记号</td>
     <td class='label_2' align='center' width='30%'>${obj.cfxdrswdj }<td>
     <td class='label_1' align='center' width='20%'>居民身份证号</td>
     <td class='label_2' align='center' width='30%'>${obj.cfxdrsfz }<td>
   </tr>
   <tr>
     <td class='label_1' align='center' width='20%'>法定代表人名称</td>
     <td class='label_2' align='center' width='30%'>${obj.cffr }<td>
