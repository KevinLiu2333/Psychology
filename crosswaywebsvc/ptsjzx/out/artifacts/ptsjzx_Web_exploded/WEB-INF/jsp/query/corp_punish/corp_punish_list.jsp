...
<body>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  class="tablelist">
				<c:forEach items="${obj.list}" var="punish" varStatus="row">
				<tr>
						<td width="5%"  align="center">${row.index+1 }</td>
						<td width="33%" align="center">${punish.corpname }</td>
						<td width="15%" align="center">${punish.organcode }</td>
						<td width="15%" align="center">${punish.punishdate }</td>
						<td width="25%" align="center">${punish.punishiunit }</td>
						<td width="*"   align="center"><a href="#" onclick="view('${punish.punishEntyId}')">查看详细</a></td>
					</tr>
				</c:forEach>
			</table>
