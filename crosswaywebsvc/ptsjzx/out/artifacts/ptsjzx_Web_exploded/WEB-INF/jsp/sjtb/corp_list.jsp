	...
	<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0"  class="tablelist">
				...
				<c:forEach items="${obj.list}" var="corp" varStatus="row">
					<tr>
						...
						<td align="center">${corp.sheetname }</td>
						<td align="center">${corp.datamonth }</td>
						<td align="center"><a href="#" onclick="view('${corp.tablename}','${corp.tbdataid}','${corp.sheetid}')">查看</a></td>
					</tr>
				</c:forEach>
	</table>
</div>
