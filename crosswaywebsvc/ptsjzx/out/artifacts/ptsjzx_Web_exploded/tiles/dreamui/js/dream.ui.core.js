...
var DWZ = {
	...
	statusCode: {ok:200, error:300, timeout:301, exception:500},
	ui:{sbar:true},
	frag:{}, //page fragment
	_msg:{}, //alert message
	_set:{
	...
	ajaxDone:function(json){
		...
		} else if (json.statusCode == DWZ.statusCode.exception) {
...
//						setTimeout(function(){navTab.closeCurrentTab();}, 100);
		...
		loadUrl: function(url,data,callback){
			$(this).ajaxUrl({url:url, data:data, type:"POST", callback:callback});
		},
		initUI: function(){
