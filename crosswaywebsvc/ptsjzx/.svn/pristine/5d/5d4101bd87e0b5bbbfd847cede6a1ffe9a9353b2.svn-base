  ...
  <!-- 隐藏域结束-->
    	<table width="80%" class="table_multilist" border="1" cellspacing="0" align="center">
    		...
    		<tr>
    			...
    			<td width="25%">&nbsp;
    				...
    				<select id="diccode" name="info.diccode"></select>
    				 -->
    				 <wd:select id="type" name="info.diccode" className="selectInput" style="width:175px;height:25px;" dicCode="<%=Constants.DIC_ACOUNT_TYPE%>" initValue="---请选择---" defaultValue="${obj.info.diccode}" onchange="changeType()"/>
    			</td>
    		...
    		<tr id="gg">
				...
				<td align="left" colspan="3">&nbsp;
					<textarea class="dftextarea" rows="3" id="sql" cols="100%" name="info.sqlvalue" >${obj.info.sqlvalue}</textarea>
				</td>
			</tr>
