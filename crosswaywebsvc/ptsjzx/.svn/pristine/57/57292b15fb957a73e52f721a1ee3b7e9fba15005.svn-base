    	...
    	<td valign="top" id="info_list">
    		<div id="con_one_1">
    			<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
        			...
        			<tr>
       			     	<td width="15%" class="info_title_aa">违法地点</td>
       				 	<td width="35%" bgcolor="#FFFFFF">
       				 	...
       				 	<td width="15%" class="info_title_aa">处罚类型</td>
        			 	<td width="35%" bgcolor="#FFFFFF"><c:if test="${obj.punishtype!='null'}">
       				 	${obj.punishtype }</c:if></td>
        			</tr>
        			<tr>
         			 	<td width="15%" class="info_title_bb">违法时间</td>
        			...
        			<tr>
        			 	...
        			 	${obj.punishNoteEnty.announcereason }</c:if></td>
       			     	<td width="15%" class="info_title_aa">处罚措施</td>
       				 	<td width="35%" bgcolor="#FFFFFF">
