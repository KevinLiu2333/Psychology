...
<script type="text/javascript">
	...
	//刷新父页面
	function refresh(){
		$('#applySubmitForm').submit();
		window.close();
	}
</script>
</head>
<body style="background: url(${ctx}/skins/images/white_bg.gif);">
	<form id="applySubmitForm" name="applySubmitForm" action="${ctx}/mlgx/toSourceApply" method="post" target="">
	<table width="98%" class="tables" style="vertical-align: middle">
		<tr>
