...
<body>
<form id="MainForm" action="${ctx}/zymlgx/toApplyAgreement" method="post">
<input type="hidden" name="resourceApply.resourceType" value="${obj.resourceApply.resourceType}">
<input type="hidden" name="resourceApply.resourceProvider" value="${obj.resourceApply.resourceProvider}">
<input type="hidden" id="fileIds" name="resourceApply.fileIds">
...
<p style="text-align:left;font-size:20px;padding-bottom: 15px;padding-top: 10px;margin-left: 60px;"><b>资源申请</b></p>
	...
	<table width="80%" class="table_multilist" align="center" style="color: navy;">
		...
		<tr>
			...
			<td width="35%" class="label_2"><wd:dicvalue name="applyDept" dicId="<%=Constants.DIC_DEPT_NAME %>" dicCode="${obj.applyDept}"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="35%" class="label_2">
				&nbsp;<input type="text" id="sqzt" name="resourceApply.applyTopic" class="dfinput" width="80%">
			</td>
		</tr>
		<tr>
			<td width="10%" class="label_1"  style="height:30px">申请人联系电话*：</td>
			<td width="35%" class="label_2">
				&nbsp;<input type="text" id="lxdh" name="resourceApply.linkmanPhone" class="dfinput" width="80%">
			</td>
		</tr>
		<tr>
			<td width="10%" class="label_1"  style="height:30px">申请人政务邮箱*：</td>
			<td width="35%" class="label_2">
				&nbsp;<input type="text" id="lxyx" name="resourceApply.linkmanMail" class="dfinput" width="80%">
			</td>
		</tr>
		<tr>
			<td width="10%" class="label_1"  style="height:30px">申请原因：</td>
			<td width="35%" class="label_2">
				<textarea class="dftextarea" id="sqyy" rows="6" cols="90" name="resourceApply.applyReason" ></textarea>
			</td>
		</tr>
		<tr>
