...
public class TbLiveroom {
    ...
    @Transient
    private String teacherFavicon;

    public String getTeacherFavicon() {
        return teacherFavicon;
    }

    public void setTeacherFavicon(String teacherFavicon) {
        this.teacherFavicon = teacherFavicon;
    }
}