...
public class TbCwkhistorysign {
    ...
    public TbCwkhistorysign() {
    	super();
    }

    public TbCwkhistorysign(Integer type, Integer months, Integer cwkstudentid, Integer cwkteacherid, Integer usedcount,
			Date addtime, Float oneprice, Double totalprice, Float score, Integer timesperday, Date endtime,
			Boolean isoverdue, Byte isfirstsign, Integer timestoday) {
		super();
		this.type = type;
		this.months = months;
