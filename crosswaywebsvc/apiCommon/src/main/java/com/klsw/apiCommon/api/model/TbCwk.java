...
public class TbCwk {
    ...
    @Transient
    private TbCwkteacher teacherInfo;
    ...
    public void setTeach_grade(String teach_grade) {
    ...
    public TbCwkteacher getTeacherInfo() {
        return teacherInfo;
    }

    public void setTeacherInfo(TbCwkteacher teacherInfo) {
