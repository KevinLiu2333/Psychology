...
public class TGaRjbxx {
    @Column(name = "RID")
    private String rid;

    @Column(name = "SYRKLBDM")
    private String syrklbdm;

    @Column(name = "SYRKLBHZ")
    ...
    @Column(name = "CSDXZQHDM")
    private String csdxzqhdm;

    @Column(name = "CSDXZQHHZ")
    ...
    @Column(name = "HJDXZQHDM")
    private String hjdxzqhdm;

    @Column(name = "HJDXZQHHZ")
    ...
    @Column(name = "YZJZRGXDM")
    private String yzjzrgxdm;

    @Column(name = "YZJZRGXHZ")
    ...
    @Column(name = "JWRYSFDM")
    private String jwrysfdm;

    @Column(name = "JWRYSFHZ")
    ...
    @Column(name = "JZDZZJGDM")
    private String jzdzzjgdm;

    @Column(name = "JZDZZJGHZ")
    ...
    @Column(name = "JZDJWHDM")
    private String jzdjwhdm;

    @Column(name = "JZDJWHHZ")
    ...
    @Column(name = "HJDJWHDM")
    private String hjdjwhdm;

    @Column(name = "HJDJWHHZ")
    private String hjdjwhhz;

    @Column(name = "HJDZZJGDM")
    private String hjdzzjgdm;

    @Column(name = "HJDZZJGHZ")
    private String hjdzzjghz;

    @Column(name = "JZDJZWID")
    private String jzdjzwid;

    @Column(name = "HJDJZWID")
    ...
    @Column(name = "SYRKZLBDM")
    private String syrkzlbdm;

    @Column(name = "SYRKZLBHZ")
    private String syrkzlbhz;

    @Column(name = "JZDJZWMC")
    private String jzdjzwmc;

    @Column(name = "HJDJZWMC")
