...
public class CorpInfo {
    ...
    @Column(name = "SELF_INSERT_DATE")
    private Date selfInsertDate;

    @Column(name = "SERVICE_INSERT_DATE")
    private Date serviceInsertDate;
