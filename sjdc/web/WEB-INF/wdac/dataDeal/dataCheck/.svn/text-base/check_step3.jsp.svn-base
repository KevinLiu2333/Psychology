						   ...
						   <div class="col-xs-12" style="padding:50px 0 50px 0;border:1px solid #dff0d8;"> 
							   <div class="form-group">
									    <div class="col-xs-7" style="float: right;">
											<label class="col-sm-3 control-label" for="form-field-1" style="text-align:left;">${obj.info.resourceName }</label>
										</div>
										<label class="col-sm-3 control-label" for="form-field-1" style="float: right;"> 资源名称： </label>
								</div>
								<div class="form-group">
										<div class="col-xs-7" style="float: right;">
											<label class="col-sm-12 control-label" style="text-align:left;"> ${obj.info.resourceTable }</label>
										</div>
										<label class="col-sm-3 control-label" for="form-field-1" style="float: right;"> 表名： </label>
								</div>
								...
								<c:if test="${obj.info.itemName != 'all'}">
									...
									<div class="form-group">
										...
										<label class="col-sm-3 control-label" for="form-field-1" style="float: right;"> 数据项字段名： </label>
									</div>
								</c:if>
					           <div class="form-group">
										<div class="col-xs-7" style="float: right;">
								...
								<div class="form-group">
										<div class="col-xs-7" style="float: right;">
											<label class="col-sm-12 control-label" style="text-align:left;">${obj.info.executionMode }</label>	
										</div>
										<label class="col-sm-3 control-label" for="form-field-1" style="float: right;"> 任务执行方式描述： </label>
								</div>
							</div>
						</form>
						</c:if>
	                       ...
	                       <div class="widget-header widget-header-small" style="background:#fff">
								 <div class="step"> 
                                    ...
                                    <span class="steps">第二步（选择检测项）</span>
                                     <span class="steps action">第三步（填写检测内容）</span>																																				
								  </div>					
					        </div>	
                        </div>
                        <form class="form-horizontal" id="form" action="${ctx }/wdac/dataCheck/toSaveTask" method="post">                         										
						   <div class="col-xs-12" style="padding:50px 0 50px 0;border:1px solid #dff0d8;"> 
							   <div class="form-group">
									    <div class="col-xs-7" style="float: right;">
									    	...
									    	<input name="info.resourceTable" value="${obj.info.viewName }" type="hidden">
									    	<input name="info.providerDepartment" value="${obj.info.deptName }" type="hidden">
											<label class="col-sm-3 control-label" for="form-field-1" style="text-align:left;">${obj.info.name }</label>
										</div>
										<label class="col-sm-3 control-label" for="form-field-1" style="float: right;"> 资源名称： </label>
								</div>
								 <div class="form-group">
					           ...
					           <div class="form-group">
								...
								<div class="form-group">
										<div class="col-xs-7" style="float: right;">
											<input type="text" id="taskDesc" name="info.executionMode" placeholder="请输入任务执行方式描述" class="col-xs-10 col-sm-5">
										</div>
										<label class="col-sm-3 control-label" for="form-field-1" style="float: right;"> 任务执行方式描述： </label>
								</div>
				...
				dicJson = eval('('+result+')');
					for(key in dicJson['2007']){
						if(key == $("#checkRule").text()){
							$("#checkRule").text(dicJson['2007'][key]);
						}
					}
			}
		});
