...
<body>
	...
	<div class='container'>
		<h3 id="disable-responsive2" class="page-header">报表类接口服务定制</h3>
		<form method="post" id="publishForm" action="${ctx}/fw/saveLink">
			<input type="hidden" name="fwInfo.fwType" value="报表类接口服务定制"/>
	        <input type="hidden" name="fwInfo.fwTypeCode" value="Dingzhi3">
