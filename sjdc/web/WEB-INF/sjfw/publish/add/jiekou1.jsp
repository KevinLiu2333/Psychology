...
<div class='container'>
    <h3 id="disable-responsive2" class="page-header">单一结果服务发布</h3>
    <form method="post" id="publishForm" action="${ctx}/fw/saveJiekou1">
        <input type="hidden" name="fwInfo.fwType" value="单一结果服务"/>
        <input type="hidden" name="fwInfo.fwTypeCode" value="Jiekou1">
   ...
   <jsp:include page="base.jsp"/>
    ...
    <div class="col-md-12 form-group">
        选择传入条件：
        <select multiple="" id="zyItems" name="zyItems"  style="width:785px" class="select2" data-placeholder="请选择传入条件...">
            <option value="">&nbsp;</option>
        </select>
    </div>
     <div class="col-md-12 form-group">
