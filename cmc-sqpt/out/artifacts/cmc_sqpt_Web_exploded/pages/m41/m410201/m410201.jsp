	...
	<body>
		<div id="div_cxtj" style="height: auto; width: 100%;">
			<div class="mini-toolbar" style="border-bottom:0;padding:0px;">
				<table style="width:100%;">
					<tr>
						<td style="width:100%;">
							<a class="mini-button" iconCls="icon-addnew" plain="true" onclick="add()">新增应用</a>
							<a class="mini-button" iconCls="icon-edit" plain="true" onclick="edit()">编辑应用</a> 
							<a class="mini-button" iconCls="icon-remove" plain="true" onclick="remove()">删除应用</a> 
						...
						<td style="white-space:nowrap;">
							...
							<input id="queryText" name="queryText" class="mini-textbox" emptyText="请输入应用代码" style="width:150px;" onenter="onKeyEnter" /> 
			...
			<div class="mini-fit">
				<div id="queryGrid" class="mini-datagrid"
					...
					<div property="columns">
						...
						<div field="ifdefcode" width="120" headerAlign="center" align="center" allowSort="true">应用代码</div>
						<div field="ifdefname" width="120" headerAlign="center" align="center" allowSort="true">应用名称</div>
		...
		<script type="text/javascript">
			...
			function add() {
				try{
					mini.open({
						url : __CONTEXT_PATH__ + "/pages/m41/m410201/WebApplication.jsp",
						allowDrag: false,
						allowResize: false,
						title : "新增WEB应用",
						width : 600,
