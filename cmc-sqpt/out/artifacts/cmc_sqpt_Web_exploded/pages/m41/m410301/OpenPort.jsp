  ...
  <body>    
    <form id="form" method="post">
        <fieldset style="border:solid 1px #aaa;padding:3px;">
            <legend >开放端口信息</legend>
            <div style="padding:5px;text-align:center;">
		        <table align="center">
		            <tr>
		                <td style="width:90px;" align="right">开放端口代码<font color="red">*</font>：</td>
		            ...
		            <tr>
		                <td align="right">开放端口名称<font color="red">*</font>：</td>
		                <td>    
		            ...
		            <tr>
		                ...
		                <td>    
		                    <input name="ifuri" class="mini-textbox" required="true" width="100%"/>
		                </td>
		            </tr> 
		            <tr>
		                <td align="right"><font color="red">提示</font>：</td>
		                <td align="left"> 
		                	<font color="red">正确的URL格式例如：localhost:8080，请不要在前面加上"http:// "！ </font>
		                </td>
		            </tr> 
		            <tr style="display:none">
						<td align="right">接口类型：</td>
						<td >
							<input id="ifsubtype" name="ifsubtype" class="mini-textbox" value="04"/>
						</td>
					</tr>
		        </table>            
            </div>
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
			...
			try{
			    ...
			    var url = "";
			    if(!/(.+:)+\d+/.test(uri)){
						mini.alert("提交失败,访问地址不符合ip:port格式");
						MiniUtils.unmaskwin();	
						return false;
			    }
				if(action=="new"){
