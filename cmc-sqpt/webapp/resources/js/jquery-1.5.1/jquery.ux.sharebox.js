	...
	$.sharebox = function(el, settings){
		...
		this.init = function() 
		{
			...
			if(settings.btn.image){
				var toolPicHtml =	'<a href="javascript:void(0)" hidefocus="hidefocus" class="insert_tools insert_pic" data-type="imagebox" node-type="toolBtn" title="' + settings.lang.insert_pic +'">ͼƬ</a>';
			}else{
				var toolPicHtml = '';
			}
