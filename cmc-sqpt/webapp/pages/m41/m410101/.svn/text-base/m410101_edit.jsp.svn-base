	...
	<table class="form-table" border="0" cellpadding="2" cellspacing="0" style="width:auto;table-layout:fixed;" >
		<tr>
			...
			<td style="width:150px;">
				<input id="ifdefcode" name="ifdefcode" class="mini-textbox" maxlength="25"  required="true" style="width:100%;" readonly="readonly"/>
		...
		<tr>
			...
			<td colspan="3">
				<div id="ifsubtype" class="mini-radiobuttonlist" repeatItems="2" repeatLayout="table"
 				   textField="text" valueField="id" data="DIC_IFSUBTYPE">
				</div> 
			</td>
		</tr>
	</table>
...
<div>
		<table border="0" align="center" cellpadding="0" cellspacing="0">
			<tr align="center">
	        	<td align="center">
	        	    <a id="test" class="mini-button" onclick="onTest">测试</a>&nbsp;&nbsp;&nbsp;       	
    ...
    try{
		...
		if(data.ifuri){	
			...
			MiniUtils.request({
				...
				data: { ifsubtype: mini.get("ifsubtype").getValue(),
						ifuri:data.ifuri},
				success: function (text) {
					MiniUtils.unmaskwin();
					if(text.detailmsg){
