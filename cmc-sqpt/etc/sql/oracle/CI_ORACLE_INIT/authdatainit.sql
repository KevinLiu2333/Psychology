...
values ('1', 'testDispatcherImpl', '条线接口监控', null, '1', to_date('24-02-2016 00:00:00', 'dd-mm-yyyy hh24:mi:ss'), '1', null, null);

insert into QRTZ_TRIGGER_CONFIG (ID, BEAN_NAME, BEAN_DESC, NOTES, VALIDITY, CREATE_TIME, CREATER, EXT1, EXT2)
values ('2', 'testWebApplicationImpl', '应用监控', null, '1', to_date('24-02-2016 00:00:00', 'dd-mm-yyyy hh24:mi:ss'), '1', null, null);

insert into QRTZ_TRIGGER_CONFIG (ID, BEAN_NAME, BEAN_DESC, NOTES, VALIDITY, CREATE_TIME, CREATER, EXT1, EXT2)
values ('3', 'testOpenPortImpl', '开放端口监控', null, '1', to_date('24-02-2016 00:00:00', 'dd-mm-yyyy hh24:mi:ss'), '1', null, null);

insert into QRTZ_TRIGGER_CONFIG (ID, BEAN_NAME, BEAN_DESC, NOTES, VALIDITY, CREATE_TIME, CREATER, EXT1, EXT2)
values ('4', 'testLowerPlatFomImpl', '下级平台监控', null, '1', to_date('24-02-2016 00:00:00', 'dd-mm-yyyy hh24:mi:ss'), '1', null, null);
