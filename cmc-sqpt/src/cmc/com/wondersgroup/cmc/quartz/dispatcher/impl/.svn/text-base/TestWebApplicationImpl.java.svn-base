...
public class TestWebApplicationImpl extends BaseQueryVSImpl implements TriggerDispatcher{
	...
	public Object executeMethod(Map<String, Object> filter) {
		...
		List<Ifdefine> ifdefineList = CommonJdbcDaoUtils.query(sql, Ifdefine.class, DispatchContent.IFTYPE_APP);
