...
/**
 * AbstractIfdefine entity provides the base persistence definition of the
 * Ifdefine entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class BaseIfdefine implements java.io.Serializable {
	...
	// Property accessors
	@Id
	@GeneratedValue(generator = "SEQ_IFDEFINEID")
    @GenericGenerator(name = "SEQ_IFDEFINEID", strategy = "native", parameters = {
	    @org.hibernate.annotations.Parameter(name = "sequence", value = "SEQ_IFDEFINEID"),
