...
/**
 * AbstractIfuser entity provides the base persistence definition of the Ifuser
 * entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class BaseIfuser implements java.io.Serializable {
	...
	// Property accessors
	@Id
	@GeneratedValue(generator = "SEQ_IFUSERID")
    @GenericGenerator(name = "SEQ_IFUSERID", strategy = "native", parameters = {
	    @org.hibernate.annotations.Parameter(name = "sequence", value = "SEQ_IFUSERID"),
	    @org.hibernate.annotations.Parameter(name = "unsaved-value", value = "0") })
	@Column(name = "IFUSERID", unique = true, nullable = false, precision = 16, scale = 0)
