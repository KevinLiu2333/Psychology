...
public class FtpUtils {
	...
	FtpClient		ftpClient;
	private String	server			= PropertyUtils.getProperty("ftp.url");
	private String	userName		= PropertyUtils.getProperty("ftp.user");
	private String	userPassword	= PropertyUtils.getProperty("ftp.pwd");
	private int		port			= 21;
