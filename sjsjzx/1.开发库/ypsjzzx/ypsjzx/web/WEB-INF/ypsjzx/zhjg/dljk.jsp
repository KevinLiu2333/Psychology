                            ...
                            <div class="col-md-3">
                                <div class="panel red-bg btn-warning">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div align="center">
                                                <span class="state-title" style="font-size:24px" id="zxrs">1</span>
...
<script type="text/javascript">
	// 从服务获取数据 http://localhost:8080/ypsjzx/fw/ptservices?unitKey=***&fwCode=***
	$.ajax({
		type:"get",
		url:"http://localhost:8080/ypsjzx/fw/ptservices?unitKey=SJ20161447233004873&fwCode=fw00013&id=F00021",
		dataType:"text",
