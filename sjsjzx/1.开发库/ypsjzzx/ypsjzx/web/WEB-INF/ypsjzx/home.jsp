...
<div id="content">
	...
	<div class="col-sm-8">
		<div class="tabbable">
		<h3 id="disable-responsive" class="page-header"><a href="#">资源目录</a></h3>
...
$(document).ready(function(){
	$.post("http://localhost:8080/ypsjzx/fw/ptservices",{unitKey:"SJ20161447233004873",fwCode:"fw00010",STATUS:"已发布"},function(data){
		var data1 = eval('('+data+')');
		var list =data1.DATA;
		var html='';
		for(var i=0;i<5;i++){
	...
	$.post("http://localhost:8080/ypsjzx/fw/ptservices",{unitKey:"SJ20161447233004873",fwCode:"fw00014",ISDEL:"0"},function(data){
		var data1 = eval('('+data+')');
		var list =data1.DATA;
		$("#syrk").html(list[0].value+'<span style="font-size: 15px">人</span>');
	});
	$.post("http://localhost:8080/ypsjzx/fw/ptservices",{unitKey:"SJ20161447233004873",fwCode:"fw00015"},function(data){
		var data1 = eval('('+data+')');
		var list =data1.DATA;
		$("#llrk").html(list.result+'<span style="font-size: 15px">人</span>');
	});
	$.post("http://localhost:8080/ypsjzx/fw/ptservices",{unitKey:"SJ20161447233004873",fwCode:"fw00016"},function(data){
		var data1 = eval('('+data+')');
		var list =data1.DATA;
		$("#zyz").html(list.result+'<span style="font-size: 15px">人</span>');
	});
	$.post("http://localhost:8080/ypsjzx/fw/ptservices",{unitKey:"SJ20161447233004873",fwCode:"fw00018"},function(data){
		var data1 = eval('('+data+')');
		var list =data1.DATA;
