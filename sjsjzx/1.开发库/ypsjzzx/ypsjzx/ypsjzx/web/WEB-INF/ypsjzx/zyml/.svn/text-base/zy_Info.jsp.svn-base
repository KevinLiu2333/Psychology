...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$.post("${fwurl}",{unitKey:"SJ20161447233004873",fwCode:"fw00009",ZY_INFO_ID:id},function(data){
			var data1 = eval('('+data+')');
			var item =data1.DATA;
		...
		$.post("${fwurl}",{unitKey:"SJ20161447233004873",fwCode:"fw00012",ZY_INFO_ID:id},function(data){
			var data1 = eval('('+data+')');
			var item =data1.DATA;
			var zdhtml='主动公开：';
			var sqhtml='依申请公开：';
