...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <h2 class="page-header" style="margin-top: 5px">用户管理
                 <span style="float: right;padding-right: 10px"><button type="button" class="btn btn-warning" onclick="window.location.href='${ctx}/suite/user/toUserEdit'">添加用户</button></span>
            </h2>
                ...
                <div class="panel-body">
                    <div class="adv-table">
                        <table  class="display table table-bordered table-striped" id="dynamic-table">
                            ...
                            <tbody>
                            <c:forEach items="${obj.userInfoList}" var="user" varStatus="row" >
                            <tr>
                                <td>${row.index+1}</td>
                                <td>${user.logonName}</td>
                                <td>${user.displayName}</td>
                                <td>${user.userType}</td>
                                <td><fmt:formatDate pattern="yyyy-MM-dd" value="${user.currentLogonDate}"/></td>
                                <td><a href="${ctx}/suite/user/toUserEdit?userId=${user.userId}">修改</a></td>
                            </tr>
                            </c:forEach>
                            </tbody>
                        </table>
