...
<body>
	...
	<div class="row">
		...
		<div class="col-md-12 form-group">
			服务调用示例：
			http://localhost:8080/wddc/fw/ptservices?unitKey=***&fwCode=***&id=${obj.info.id }
		</div>
		<div class="col-md-12 form-group">
...
<script type="text/javascript">
	...
	var url = "http://localhost:8080${ctx }/fw/ptservices?unitKey=SJ20161447233004873&fwCode=fw00013&id=${obj.info.id}";
	$.ajax({
		type:"get",
		url:url,
		dataType: 'text',
