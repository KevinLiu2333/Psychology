...
<body>
	...
	<br>
	<br>
<form id="form" action="${ctx}/suite/data/mult/toTestParam" method="post">
	<div class="container">
		<h3 class="page-header" style="margin-top: 5px">测试参数</h3>
		<div class="col-md-12">
			<br>
				<input type="hidden" name="id" value="${obj.info.id }"/>
		...
		<div class="col-md-12 form-group">统计名称：&nbsp;${obj.info.name }
		</div>
		<c:if test="${obj.result!=null }">
			<div class="col-md-12 form-group">
				...
				<table class="display table table-bordered table-striped"  width="80%" cellpadding="3px" cellspacing="1" align="center" style="border-collapse:separate; border-spacing:0px 10px;">
					<c:forEach items="${obj.result }" var="re">
						<tr>
