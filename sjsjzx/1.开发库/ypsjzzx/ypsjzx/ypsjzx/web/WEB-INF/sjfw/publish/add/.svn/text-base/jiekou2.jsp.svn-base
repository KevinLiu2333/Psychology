...
<div class='container'>
    <h3 id="disable-responsive2" class="page-header">单一统计数据服务发布</h3>
    <form method="post" id="publishForm" action="${ctx}/fw/saveJiekou2">
        <input type="hidden" name="fwInfo.fwType" value="单一统计数据服务"/>
        <input type="hidden" name="fwInfo.fwTypeCode" value="Jiekou2">
