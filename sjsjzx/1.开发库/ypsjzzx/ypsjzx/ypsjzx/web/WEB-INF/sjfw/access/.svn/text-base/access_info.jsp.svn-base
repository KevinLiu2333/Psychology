...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="page-header" style="margin-top: 5px">${obj.fwInfo.fwName } &nbsp;授权列表
                <span style="float: right;padding-right: 10px"><button type="button" class="btn btn-warning" onclick="window.location.href='${ctx}/fw/editFwAccess?fwInfoId=${accessInfo.fwInfoId}'">新增授权</button></span>
            </h2>
                    ...
                    <div class="adv-table">
                        <table  class="display table table-bordered table-striped" >
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="${ctx}/fw/editFwAccess?fwInfoId=${accessInfo.fwInfoId}&fwAccessId=${accessInfo.fwAccessId}">修改</a>
                                    <a href="${ctx}/fw/delFwAccess?fwInfoId=${accessInfo.fwInfoId}&fwAccessId=${accessInfo.fwAccessId}">删除</a>
                                </td>
                            </tr>
                             </c:forEach>
