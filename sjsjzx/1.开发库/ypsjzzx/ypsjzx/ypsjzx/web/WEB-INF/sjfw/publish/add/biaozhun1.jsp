...
<div class='container'>
    <h3 id="disable-responsive2" class="page-header">标准规范服务</h3>
    <form method="post" id="publishForm" action="${ctx}/fw/saveBiaozhun1">
        <input type="hidden" name="fwInfo.fwType" value="标准规范服务">
        <input type="hidden" name="fwInfo.fwTypeCode" value="Biaozhun1">
