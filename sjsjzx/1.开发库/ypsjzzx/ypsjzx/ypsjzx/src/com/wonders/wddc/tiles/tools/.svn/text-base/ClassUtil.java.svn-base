...
public class ClassUtil {
	...
	/**
	 * 在packname包下搜索所有以endStrs结尾的类
	 * @param packname
	 * @param inter
	 * @return
	 */
	@SuppressWarnings( "unchecked" )
	public static List<Class> getpackClsByEndStr(String packname,String... endStrs){
		List<Class> classes = new ArrayList<Class>();
		List<Class> clses = getClasses(packname);
		for(Class cls:clses){
			for(String endstr:endStrs){    
	            if(cls.toString().endsWith(endstr)){
					classes.add(cls);
	            }
	        }  
		}
	 ...
	 */
	@SuppressWarnings( "unchecked" )
	public static List<Method> getMethodByClassName(String className){
