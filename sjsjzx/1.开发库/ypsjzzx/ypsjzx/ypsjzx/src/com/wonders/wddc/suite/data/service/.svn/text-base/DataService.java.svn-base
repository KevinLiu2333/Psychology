...
public class DataService {
	...
	public Object gainresult(String id,Map<String, String> params,String type){
		...
		if(bo == null){
			...
			result.put(FwConstants.RS_MAP_COUNT, "0");
			result.put("ERROR", "1");
	...
	class KeyValueCallBack implements SqlCallback{
		...
		public Object invoke(Connection conn, ResultSet rs, Sql sql)
			...
			result.put(FwConstants.RS_MAP_DATA, re);
			result.put(FwConstants.RS_MAP_COUNT, ""+count);
			return result;
		}
	}
	/**
	...
	class ListMapCallBack implements SqlCallback{
		...
		public Object invoke(Connection conn, ResultSet rs, Sql sql)
			...
			result.put(FwConstants.RS_MAP_DATA, list);
			result.put(FwConstants.RS_MAP_COUNT, ""+count);
			return result;
		}
	}
