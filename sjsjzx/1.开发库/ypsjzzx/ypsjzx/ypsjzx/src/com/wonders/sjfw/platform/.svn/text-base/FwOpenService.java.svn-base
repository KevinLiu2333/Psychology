...
public class FwOpenService {
    ...
    public String services(HttpServletRequest request,String unitKey,String methodKey,String format,String rsStyle,String rsStructure) {
        ...
        if(Strings.isBlank(format)){
        	format = FwConstants.FORMAT_JSON;
        }
    ...
    public Map<String, Object> example(HttpServletRequest request,String fwInfoId,String format){
    	//1.定义返回结果
        ...
        //2.组装参数
        FwParam fwParam = paramSpu.putExampleParam(request,fwInfoId,format);
        //3.调用服务的处理单元处理服务
