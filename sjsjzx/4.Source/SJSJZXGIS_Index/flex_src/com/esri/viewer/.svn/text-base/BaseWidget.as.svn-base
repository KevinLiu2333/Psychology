package com.esri.viewer
{
	...
	import com.esri.viewer.utils.XMLUtil;
	...
	public class BaseWidget extends Module implements IBaseWidget
	{
		...
		public static const ICON_URL:String = UrlUtil.URL_DOMAIN + "assets/images/";
		
	    /**
	     * The default widget icon.
	     */
	    private var _widgetIcon:String = ICON_URL + "i_widget.png";
	    ...
	    public function BaseWidget()
	    {
			...
			ViewerContainer.addEventListener(AppEvent.DATA_ALL_SENT, fetchedAllData);
	    ...
	    {
	        _widgetConfig = value;
			_widgetConfig = UrlUtil.UrlComplete(_widgetConfig);
	    }
		 ...
		 * @return value of the state string defined in BaseWidget.
		 */
		...
		protected var sharedData:Hashtable ;
		
		protected function newDataPublished(event:AppEvent):void{
			sharedData = event.data.data as Hashtable;
		}
		
		protected function fetchedAllData(event:AppEvent):void{
			sharedData = event.data as Hashtable;
			ViewerContainer.removeEventListener(AppEvent.DATA_ALL_SENT, fetchedAllData);
		}
			
		public function publishSharedData(key:String, data:Object):void{
			var sharedata:Object = {"key": key, "data": data};
			ViewerContainer.dispatchEvent(new AppEvent(AppEvent.DATA_PUBLISH, sharedata));
		}
	    
		public function fetchSharedData(key:String):void{
			var sharedata:Object = {"key": key};
			ViewerContainer.dispatchEvent(new AppEvent(AppEvent.DATA_FETCH, sharedata));
		}
	     ...
	     */
	    public function fetchAllSharedData():void 
	    {
	    ...
	    private function configLoad():void
	    {
	        if (_widgetConfig)
	        {
	            ...
	            configService.url = UrlUtil.UrlComplete(_widgetConfig);
		...
		public function get allClassName():String{
		...
		public function get widget_Config():XML{
			return configData.widget_Config;
		}
		...
		public function get gis_Config():XML{
			return configData.gis_Config;
		}
		
		public function get project_UrlROOT():String{
			return configData.project_UrlROOT;
		}
		public function get servlet_UrlROOT():String{
			return configData.servlet_UrlROOT;
		}
		
		public function get gisdata_UrlROOT():String{
			return configData.gisdata_UrlROOT;
		}
		
		public function getProjectConfigNodeValue(xmlNode:String):String{
			return configData.getProjectConfigNodeValue(xmlNode);
		}
		
		public function getGISConfigNodeValue(xmlNode:String):String{
			return configData.getGISConfigNodeValue(xmlNode);
		}
		
		public function getWidgetConfigNode(xmlNode:String):XML{
			return configData.getWidgetConfigNode(xmlNode);
		}
		
		public function get WidgetConfigXML():XML{
			//var classname:String = allClassName.replace("widgets/","");
			var list:XMLList = XMLUtil.getByXPath(widget_Config, allClassName);
