...
public class WidgetTemplate extends SkinnableContainer implements IWidgetTemplate
{
    ...
    private var _widgetIcon:String = UrlUtil.URL_DOMAIN + "assets/images/i_widget.png";
...
//        }
		...
		//当移动弹出框时，超出电脑屏幕减去弹出框的宽度时，不允许弹出框超出电脑屏幕
       if (widget.x > (systemManager.screen.width - widget.width ))
       {
           widget.x = systemManager.screen.width - widget.width;
       }
