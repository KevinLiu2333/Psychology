package com.wonders.components
{
	...
	public class CheckTreeRenderer extends TreeItemRenderer
	{
		...
		private var inner:String 	= "com/wonders/components/inner.png";
		...
		private function checkBoxToggleHandler(event:MouseEvent):void
		{
			if (data)
			{
				...
				this.owner.dispatchEvent(new CheckTreeEvent(CheckTreeEvent.CHECK_TREE_CHECKED));
			}
		}
