...
public class XMLSupport {
	private static Logger log = Logger.getLogger(XMLSupport.class);
	...
	public static Schema convertElementToSchema(Element element)
		...
		log.debug("在方法convertElementToSchema(Element element)里,"
				+ "已经把Dom型的<xsd:schema>元素转换成"
				+ "JDom型了Element element,打印schema树形结构:");
		log.debug(content);
		if (content != null) {
