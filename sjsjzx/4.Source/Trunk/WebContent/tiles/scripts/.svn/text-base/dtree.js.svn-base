...
function dTree(objName) {
	...
	this.icon = {
		root				: '/framework/skins/images/dtree/img/base.gif',
		folder			: '/framework/skins/images/dtree/img/folder.gif',
		folderOpen	: '/framework/skins/images/dtree/img/folderopen.gif',
		node				: '/framework/skins/images/dtree/img/page.gif',
		empty				: '/framework/skins/images/dtree/img/empty.gif',
		line				: '/framework/skins/images/dtree/img/line.gif',
		join				: '/framework/skins/images/dtree/img/join.gif',
		joinBottom	: '/framework/skins/images/dtree/img/joinbottom.gif',
		plus				: '/framework/skins/images/dtree/img/plus.gif',
		plusBottom	: '/framework/skins/images/dtree/img/plusbottom.gif',
		minus				: '/framework/skins/images/dtree/img/minus.gif',
		minusBottom	: '/framework/skins/images/dtree/img/minusbottom.gif',
		nlPlus			: '/framework/skins/images/dtree/img/nolines_plus.gif',
		nlMinus			: '/framework/skins/images/dtree/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
