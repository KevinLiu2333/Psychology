		...
		<dl class="con_frame">
			<dt >
                ...
                <ul class="pic_link" style="overflow-y:auto;height:195px;">
                	<li style="width: 150px;"><a href="${ctx}/config/query/toResult?saveId=1460623452768" target="_blank"><img src="${ctx }/skins/index/images/fc_icon_01.png" >人口基础数据查询</a></li>
            ...
            <dd class="blue">
                ...
                <h2><a href="${ctx}/api/toApplyView" target="main_frame">申请使用>></a></h2>
            </dd>
		</dl>
		<dl class="con_frame">
        	<dt>
            	<h1 class="tit"><span>我的数据资源服务</span></h1>
                <ul class="list_link" style="overflow-y:auto;height:195px;">
            ...
            <dd class="red">
                ...
                <h2><a href="${ctx}/zymlgl/toContentIndex" target="main_frame">申请使用>></a></h2>
            </dd>
        </dl>
        <dl class="con_frame">
        	<dt>
            	<h1 class="tit"><span>我的数据接口服务</span></h1>
                <ul class="list_link" style="overflow-y:auto;height:230px;">
...
function addApplyTask(){
	$('#queryForm').attr("action","${ctx}/zymlgl/toIndex");
