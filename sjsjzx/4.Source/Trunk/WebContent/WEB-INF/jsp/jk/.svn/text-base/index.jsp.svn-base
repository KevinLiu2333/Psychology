...
<title>松江区政务数据中心-实时安全监控平台</title>
...
<div class="header" id="header">
	<h1 style="width:200px">实时安全监控平台</h1>
    <span>
...
<div class="menu" id="menu">
	<dl>
		<dt class="menu_tCon">日志管理</dt>
		<dd>
			<a href="${ctx}/log/toIndex" id="ii" target="main_frame" onClick="changeposition('日志查看')"><img src="${ctx}/skins/style/images/menu_icon_18.png" pic-id="menu_icon_18">日志查看</a>
		</dd>
	</dl>
	<!--<dl>
		<dt class="menu_tCon">统一预警</dt>
		<dd>
			<a href="${ctx}/jk/toGnyj" target="main_frame" onClick="changeposition('功能预警')" id="gnyj"><img src="${ctx}/skins/style/images/menu_icon_18.png" pic-id="menu_icon_18">功能预警</a>
	...
	--><dl>
		...
		<dd>
			<a href="http://192.168.104.4:8080/cutecloud/" target="main_frame"><img src="${ctx}/skins/style/images/menu_icon_18.png" pic-id="menu_icon_18">资源池</a>
			<!--  <a href="${ctx}/jk/toHardWare" target="main_frame" onClick="changeposition('硬件设备')" id="yjsb"><img src="${ctx}/skins/style/images/menu_icon_18.png" pic-id="menu_icon_18">硬件设备</a>
