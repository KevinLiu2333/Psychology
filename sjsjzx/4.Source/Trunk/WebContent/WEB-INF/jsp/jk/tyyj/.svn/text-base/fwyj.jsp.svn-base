	...
	<div class="mian_box">
		<div class="main_01">
			<table class="age_tab" width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td width="50%">人口库查询服务</td>
					<td width="50%"><input type="number"  value="50"/>
					<input class="btn1" style="width: 100px" type="button" value="修改">
					</td>
				</tr>
				<tr>
					<td width="50%">法人库查询服务</td>
					<td width="50%"><input type="number"  value="100"/>
					<input class="btn1" style="width: 100px" type="button" value="修改">
					</td>
				</tr>
				<tr>
					<td width="50%">房屋库查询服务</td>
					<td width="50%"><input type="number"  value="80"/>
					<input class="btn1" style="width: 100px" type="button" value="修改">
					</td>
				</tr>
			</table>
		...
		<div class="main_01">
			<div style="height: 400px" id="fwjk"></div>
		</div>
	</div>
</body>
...
function drawgnjk(){
	...
	require([
		...
		var myChart = ec.init(document.getElementById("fwjk"));
		var option={
				tooltip : {
			        trigger: 'axis'
			    },
			legend: {
		        data:['人口库查询服务','法人库查询服务','房屋库查询服务']
		    },
		    calculable : true,
		    xAxis : [
		             {
