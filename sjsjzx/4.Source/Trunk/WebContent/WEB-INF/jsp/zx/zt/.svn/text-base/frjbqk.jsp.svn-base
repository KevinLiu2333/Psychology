	...
	<div class="mian_box">
		...
		<ul class="user_ui main_01" style="height:170px;">
			...
			<li><b class="ui_bg02" style="height:135px;">
					<h5>本月法人设立数量</h5><a><span id="byxz"></span></a>
			</b></li>
			<li><b class="ui_bg03" style="height:135px;">
					<h5>松江区注册企业总数</h5><a><span id="BYZX"></span></a>
			</b></li>
			<li><b class="ui_bg04" style="height:135px;">
					<h5>松江区经营企业总数</h5><a><span id="BG"></span></a>
			</b></li>
		</ul>
		...
		$.post("${ctx}/echarts/queryjson?theme_id=31",
				...
				function(data, textStatus){
					data = eval('('+data+')');
					$("#SYFR").text(data['松江区实有法人数']);
					$("#byxz").text(data['法人本月变更']);
					$("#BYZX").text(data['松江区注册企业']);
					$("#BG").text(data['松江区经营企业']);
				});
			require.config({
				paths : {
