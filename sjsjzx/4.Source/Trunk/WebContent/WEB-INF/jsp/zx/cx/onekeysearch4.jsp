...
<body>
	<form action="${ctx}/cx/onekeysearcheList" method="post"
		style="background: white; height: 600px;">
		<img src="${ctx}/skins/images/zhly/4.png" width="100%" height="512" border="0" usemap="#Map" />
		<map name="Map" id="Map">
			...
			<area shape="rect" coords="2,329,1151,355" href="${ctx}/cx/toOneKeySearch5" />
			<area shape="rect" coords="1,355,1149,379" href="${ctx}/cx/toOneKeySearch6" />
		</map>
	</form>
</body>
</html>