...
<script type="text/javascript">
  ...
  <form id="queryForm" name="queryForm" action="${ctx}/sqlinfo/tosqlinfo" method="post">
   ...
   <tr height="30" >
   	<td align="center" width="28%" style="line-height:25px;">&nbsp;&nbsp;统计类型：
   	<wd:select className="selectInput" initValue="---请选择---" name="filter_str_diccode_eq" dicCode="1044" defaultValue="${param.filter_str_diccode_eq }" style="width:220px;"/></td>
	<td align="left">
