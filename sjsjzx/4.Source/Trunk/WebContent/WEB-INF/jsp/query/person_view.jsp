				  ...
				  <tr>
				    ...
				    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" >
				      ...
				      <tr>
				        ...
				        <td colspan="3"><wd:dicvalue dicId="1059" dicCode="${obj.person.xbdm}"/></td>
				        </tr>
				      <tr>
				      ...
				      <tr>
				        ...
				        <td width="28%"><wd:dicvalue dicId="1060" dicCode="${obj.person.mzdm}"/></td>
				      </tr>
				      <tr>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><ul class="tag">
        <li id="one1" onclick="setTab('one',1,${fn:length(obj.deptlist)+1})" class="active"><a href="javascript:void(0)">基本信息</a></li>
        <!-- <li id="one2" onclick="setTab('one',2,3)"><a href="javascript:void(0)">民政局</a></li> -->
   		<c:forEach items="${obj.deptlist}" var="dept" varStatus="row">
   			<li id="one${row.index+2}" onclick="setTab('one',${row.index+2},${fn:length(obj.deptlist)+1})"><a href="javascript:void(0)"><wd:dicvalue dicId="1069" dicCode="${dept }"/></a></li>
   		</c:forEach>
    </ul></td>
  </tr>
  <tr>
    ...
    <!-- <div id="con_one_2" style="display:none;"></div> -->
    	<c:forEach items="${obj.deptlist}" var="dept" varStatus="row">
    		<div id="con_one_${row.index+2}" style="display:none;height: 200px">
