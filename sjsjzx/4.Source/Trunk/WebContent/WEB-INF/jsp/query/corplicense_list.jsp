...
<title>松江区政务数据中心-法人资质信息查询</title>
</head>
<body>
	<form  id="queryForm" name="queryForm" action="${ctx }/query/toCorpLicenseList" method="post">
	...
	<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0"  class="tablelist">
		...
		<c:forEach items="${obj.corpLicenses}" var="corpLicense" varStatus="row">
					<tr>
						...
						<td align="center">
							${corpLicense.licensecode }
						</td>
						<td align="center">
							<fmt:formatDate value="${corpLicense.licensedata }" pattern="yyyy年MM月dd日"/>
						</td>
