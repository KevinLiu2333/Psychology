...
<!-------------------数据展示 start------------------------------->
			...
			<div align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="minButton" style="width: 120px" onclick="exportexcel()" value="导出excel" /></div> 
			<div>&nbsp;</div>
			<center>
...
function exportexcel(){
	window.location.href="${ctx}/query/statChart/export?saveId=${obj.saveId}"
}
