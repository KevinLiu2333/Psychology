		...
		<input type="hidden" id="checkedPerson" name="resourceApply.checkedPerson" value="${obj.resourceApply.checkedPerson}">
			...
			<tr>
				...
				<td class="label_2" colspan="3">
					&nbsp;<wd:select id="status" name="resourceApply.status" className="selectInput" style="width:175px;height:25px;" dicCode="<%=Constants.DIC_APPLY_RESULT %>" initValue="---请选择---" defaultValue="${obj.resourceApply.status}" onchange="changeReason()"/>
				</td>
			</tr>
