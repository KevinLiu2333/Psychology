...
<p style="text-align:left;font-size:20px;padding-bottom: 15px;padding-top: 10px;margin-left: 60px;"><b>API资源申请</b></p>
	...
	<table width="80%" class="table_multilist" align="center" style="color: navy;">
		<tr>
			...
			&nbsp;&nbsp;7、落款{签署}。</br>
			&nbsp;&nbsp;8、签署日期。</br></br></br>
			<p style="float: right">申请日期：<fmt:formatDate value="${obj.apiApply.applyDate }" pattern="yyyy年MM月dd日"/>&nbsp;&nbsp;</p>
			</br></br>
			</td>
		</tr>
	</table>
	<div style="text-align: center;margin-top: 20px;padding-bottom: 10px">
		<input type="button" id="printView"  class="button" value="打印" onclick="printInfo('${obj.apiApply.applyBatch}');"/>&nbsp;&nbsp;
	</div>
</form>
</body>
</html>