	...
	<table width="80%" class="table_multilist" align="center">
		<tr>
			...
			<td width="35%" class="label_2">
				&nbsp;<input type="text" class="dfinput" style="width:95%" id="serviceName" name="service.serviceName" value="${obj.service.serviceName}" datatype="*1-50"nullmsg="请输入Api名称！" errormsg="请输入少于50个汉字！"/>
			</td>
			<td class="label_1" width="15%" style="text-align:right; height:30px">简介:</td>
			<td class="label_2" width="35%">
				&nbsp;<input type="text" class="dfinput" style="width:95%" id="summary" name="service.summary" value="${obj.service.summary}" datatype="*1-200" nullmsg="请输入简介！" errormsg="请输入少于200个汉字！"/>
			</td>
		</tr>
		<tr>
			<td style="text-align:right; height:30px" class="label_1">url：</td>
			<td class="label_2">
				&nbsp;<input type="text" class="dfinput" style="width:95%" id="url" name="service.url" value="${obj.service.url}" datatype="*1-200" nullmsg="请输入url！" errormsg="请输入少于200个汉字！"/>
			</td >
			<td style="text-align:right; height:30px" class="label_1">api方法:</td>
			<td class="label_2">
				&nbsp;<input type="text" class="dfinput" style="width:95%" id="function" name="service.function" value="${obj.service.function}" datatype="*1-50" nullmsg="请输入api方法！" errormsg="请输入少于50个汉字！"/>
			</td>
		</tr>
		<tr>
			<td style="text-align:right; height:30px" class="label_1">传入参数：</td>
			<td class="label_2">
				&nbsp;<input type="text" class="dfinput" style="width:95%" id="param" name="service.param" value="${obj.service.param}" datatype="*1-100" nullmsg="请输入调用参数！" errormsg="请输入少于100个汉字！"/>
			</td>
			<td style="text-align:right; height:30px" class="label_1">返回内容:</td>
			<td class="label_2">
				&nbsp;<input type="text" class="dfinput" style="width:95%" id="returnParam" name="service.returnParam" value="${obj.service.returnParam}" datatype="*1-50" nullmsg="请输入返回参数！" errormsg="请输入少于50个汉字！"/>
			</td>
		</tr>
		<tr>
