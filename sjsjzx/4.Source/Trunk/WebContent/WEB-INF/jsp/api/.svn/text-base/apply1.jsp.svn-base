...
<title>松江区政务数据中心-数据申请公开协议</title>
...
<body>
<form id="mainForm" name="mainForm" action="${ctx}/api/toApply2" method="post"> 
<input type="hidden" name="id" value="${obj.id }" />
<h2 align="center">上海松江区区数据信息共享协议</h2>
<iframe width="850px" height="400px"  src="${ctx}/api/xieyi"></iframe>
