...
<div class="search_wrap">
  <div class="search clear">
      <div id="contentOrDept" align="left" style="text-align:center;line-height:60px;color:aliceblue;">
			资源分类：&nbsp;&nbsp;&nbsp;
			<input name="searchType" type="radio" value="content" class="searchType">&nbsp;按基础&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input name="searchType" type="radio" checked="checked" value="dept" class="searchType">&nbsp;按专题
		</div>
	...
	<div class="tag_content">
		 ...
		 <ul class="tag" >
		  <li id="one1" onclick="setTab1('one',1,3)" class="active"><a href="#tab${row.index+1}">松江区科委</a></li>
		 </ul>
