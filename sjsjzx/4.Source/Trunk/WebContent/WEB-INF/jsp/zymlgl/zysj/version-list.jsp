...
function query(resourceId){
	...
	var href = '${ctx}/zy/templet/uploadDataUI?dataMon='+month; 
...
<body style="width:96%">
				...
				<tbody>
					<c:forEach items="${obj.resourceFileList}" var="resourceFile" varStatus="row">
						<tr align="center">
							...
							<td><a href="#" onclick="toViewResource('${obj.tableName}','${resourceFile.id}','${resourceFile.resourceId}');">预览</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
	...
	<script type="text/javascript">
	function toViewResource(tableName,fileId,resourceId){
		window.showModalDialog("${ctx}/zy/templet/toZxbmList?tableName="+tableName+"&fileId="+fileId+"&resourceId="+resourceId,self,"dialogWidth=1080px;dialogHeight=600px;resizable:no;status:no;scroll:yes;");
	}
	</script>
</body>
</html>