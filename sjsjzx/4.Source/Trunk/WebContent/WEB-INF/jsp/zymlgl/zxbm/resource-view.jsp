	...
	<form id="MainForm" action="" method="post">
	    ...
	    <c:if test="${obj.resource.status != '2'}">
		    <div style="margin-left: 30px;">
		    	<h1 style="margin-left: 41.3%; font-size: 18px;">资源审核意见</h1><br>
		    	<table width="80%" style="margin-left:1%;" align="center" class="table_multilist" >
					<tr align="center">
					...
					<c:forEach items="${obj.auditResultList}" var="opnn" varStatus="row">
						<tr align="center">
							...
							<td><wd:dicvalue dicId="1018" dicCode="${opnn.opnnType}"/></td>
							<td>${opnn.opnnMemo}</td>
						</tr>
					</c:forEach>
				</table>
