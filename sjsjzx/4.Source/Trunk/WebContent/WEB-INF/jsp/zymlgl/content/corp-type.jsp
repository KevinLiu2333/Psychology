...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	    ...
	    <div align="center">
				<input type="text" id="gjz_frl" class="dfinput" style="margin-left: 30px;margin-top: 20px;width: 400px;height: 32px;" value="${obj.keyWord}">
			    &nbsp;&nbsp;<input type="button" class="minButton" style="width:80px;height: 32px;" onclick="query(2)" value="查  询"/>
			    
			   	<font style="font-size: 15px;">排序</font>：
			   	<select id="orderByValue_frl" onchange="changeValue('2')">
	    ...
	    <div style="margin-bottom: 5px;margin-top:20px;margin-left: 20px;font-size: 15px;">共&nbsp;${obj.frlCount}&nbsp;个资源目录</div>
