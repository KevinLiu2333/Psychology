...
<table class="mxList" style="width:90%; text-align:center" >
	...
	<c:if test="${obj.resource.status eq '10713'}">
	<tr>
		<td class="label_1" width="15%">操作</td>
		<td class="label_2" width="85%" colspan="3">
			&nbsp;<wd:select id="opnnType" name="opnn.opnnType" dicCode="1018" className="selectInput" style="width:175px;height:25px;" initValue="---请选择---" onchange="changeReason()"/>
		</td>
	</tr>
	...
	<c:if test="${obj.resource.status eq '10714'}">
	<tr>
		<td class="label_1" width="15%">操作</td>
		<td class="label_2" width="85%" colspan="3">
			&nbsp;<wd:select id="opnnType" name="opnn.opnnType" dicCode="1018" className="selectInput" style="width:175px;height:25px;" initValue="---请选择---" onchange="changeReason()"/>
	...
	<tr>
		<td class="label_1" width="15%">说明备注</td>
		<td class="label_2" width="85%" colspan="3">
