...
/**
 * @author Wanda
 * 法人核心表-法人基本信息标签关联表视图实体类
 */
@View("SJTZ_VIEW_CORP")
public class SjtzViewCorp {
	/**
	 * 专题标签集IDs
	 */
	@Column("LABEL_IDS")
	...
	**/
	...
	public String getLabelHzs() {
		return labelHzs;
	}
	public void setLabelHzs(String labelHzs) {
		this.labelHzs = labelHzs;
	}
