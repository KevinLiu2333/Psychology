package com.wonders.tiles.query.statform.service;
...
public class StatFormService {
	 ...
	 * @return 
	 */
	public List<FormSave> querySaveByName(String saveName){
		return dao.query(FormSave.class, Cnd.where("name", "like", "%"+saveName+"%"));
	}
	/**
	 * 根据分类、名称获取查询定义
	 * @param saveName
	 * @return
	 */
	public List<FormSave> querySave(String saveName,String [] themeIds){
		...
		return dao.query(FormSave.class, cri);
	}
	/**
	 * 获取全部主题列表
	 * @return QueryTheme对象列表
	 ...
	 * @return
	 */
	public List<FormSave> querySaveListByTheme(String [] themeIds){
		Criteria cri = Cnd.cri();
		cri.where().andIn("themeId", themeIds);
		cri.getOrderBy().desc("queryCount");
		return dao.query(FormSave.class, cri);
	 ...
	 * @return 
	 */
	public FormSave queryFormSaveById(String saveId){
		return dao.fetch(FormSave.class, saveId);
	}
	...
	public void addQueryCount(String saveId,int queryCount){
		dao.update(FormSave.class, Chain.make("queryCount", queryCount), Cnd.where("saveId", "=", saveId));
	}
	 ...
	 * @param query 定义对象
	 */
	public void addFormSave(FormSave query){
		dao.insert(query);
	}
	 ...
	 * @param query 定义对象
	 */
	public void updateFormSave(FormSave query){
		dao.update(query);	
	}
	 ...
	 * @return
	 */
	public List<FormSave> querySaveList(String type){
		Criteria cri = Cnd.cri();
		cri.getOrderBy().desc("queryCount");
	 ...
	 * @param saveId  查询定义主键
	 */
	public void removeFormSave(String saveId){
		dao.delete(FormSave.class, saveId);
	}
	/**
	 * 查询全部结果 
	 * @param querySql 查询语句
