 ...
 *
 */
public final class CJKDigitTokenizer extends Tokenizer {
     ...
     * @param in I/O reader
     */
    public CJKDigitTokenizer(Reader in) {
      super(in);
    }

    public CJKDigitTokenizer(AttributeSource source, Reader in) {
      super(source, in);
    }

    public CJKDigitTokenizer(AttributeFactory factory, Reader in) {
      super(factory, in);
    }
