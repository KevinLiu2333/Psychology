 ...
 * 
 * <p>
 * Chinese has four pitched tones and a "toneless" tone. They are called P铆ng(骞��,
 * flat), Sh菐ng(涓��, rise), Q霉(鍘��, high drop), R霉(鍏��, drop) and Qing(杞��, toneless).
 * Usually, we use 1, 2, 3, 4 and 5 to represent them.
 * 
 * <p>
 * This class provides several options for output of Chinese tones, which are
 * listed below. For example, Chinese character '鎵��'
 * 
 * <table>
 * <tr>
 * <th>Options</th>
