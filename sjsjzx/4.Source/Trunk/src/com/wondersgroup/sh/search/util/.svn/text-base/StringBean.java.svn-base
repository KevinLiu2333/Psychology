...
public class StringBean extends NodeVisitor implements Serializable {
	...
	private static final long serialVersionUID = -84592721259415510L;
	...
	/** If <code>true</code> regular space characters are substituted for non-breaking spaces in the text output. */
	protected boolean mReplaceSpace;

	/** If <code>true</code> sequences of whitespace characters are replaced with a single space character. */
	 ...
	 * which is possibly expensive.
	 * 
	 * @param collapse If <code>true</code>, sequences of whitespace will be
