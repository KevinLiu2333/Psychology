...
/**
 * 取得 Microsoft Power Point 文件正文内容 (2007版) <br>
 * 
 * @author 虞越
 * @version 1.6 <br>
 *          created 2008/10/13
...
public class XmlPowerPointExtractor extends AbstractExtractor {//modified by fengjia

	/**
	 * 取得 Microsoft Power Point 文件正文内容 (2007版), 文件后缀一般为 pptx
	 * 
	 * @param stream
	 *            文件流
	 * @return 正文内容
