...
import com.ahwzsoft.unbiz.common.exception.IllegalPathException;
...
public abstract class FileUtil {
    ...
    public static void test() throws FileSystemException {
    	...
    	FileObject fileObject = fsManager.resolveFile("D://itn//maven-repo.zip");
    	System.out.println(fileObject.getName());
    }
    
    public static void test2() throws FileSystemException {
    	StaticUserAuthenticator auth = new StaticUserAuthenticator("ftp://120.55.71.153/", "brook", "brook123");
    	FileSystemOptions opts = new FileSystemOptions();
    	DefaultFileSystemConfigBuilder.getInstance().setUserAuthenticator(opts, auth);
    	FileObject fo = VFS.getManager().resolveFile("ftp://root@120.55.71.153/zeus.war", opts);
    	System.out.println(fo.getName() + ":" + fo.isFile());
    }
