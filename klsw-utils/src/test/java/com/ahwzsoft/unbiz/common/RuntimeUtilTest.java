...
public class RuntimeUtilTest extends CachedLogger {
    ...
    public void currentClassMethod() {
        assertEquals("com.ahwzsoft.unbiz.common.RuntimeUtilTest.currentClassMethod", RuntimeUtil.currentClassMethod());
    }
    ...
    public void currentClassName() {
        assertEquals("com.ahwzsoft.unbiz.common.RuntimeUtilTest", RuntimeUtil.currentClassName());
    }

    @Test
    public void currentNamespace() {
        assertEquals("com.ahwzsoft.unbiz.common.RuntimeUtilTest.currentNamespace", RuntimeUtil.currentNamespace());
