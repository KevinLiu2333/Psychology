...
import com.ahwzsoft.unbiz.common.ClassLoaderUtil;
import com.ahwzsoft.unbiz.common.CollectionUtil;
import com.ahwzsoft.unbiz.common.exception.ClassInstantiationException;
import com.ahwzsoft.unbiz.common.exception.ServiceNotFoundException;
import com.ahwzsoft.unbiz.common.logger.CachedLogger;
import com.ahwzsoft.unbiz.common.sample.MyService;
...
public class ClassLoaderUtilTest extends CachedLogger {
    ...
    public void loadServiceClass() throws Exception {
        ...
        try {
            assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass("com.ahwzsoft.unbiz.common.sample.MyService",
        ...
        try {
            assertEquals(MyService.class,
                    ClassLoaderUtil.loadServiceClass("com.ahwzsoft.unbiz.common.sample.MyService", (ClassLoader) null));
            fail("expected ServiceNotFoundException");
        } catch (ServiceNotFoundException e) {
        }
    }
    ...
    public void loadServiceClass_ClassNameServiceId() throws Exception {
        ...
        assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass("com.ahwzsoft.unbiz.common.sample.MyService",
                "com.ahwzsoft.unbiz.common.sample.MyService", getClass().getClassLoader()));
        assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass("com.ahwzsoft.unbiz.common.sample.MyService",
                "com.ahwzsoft.unbiz.common.sample.MyService", (ClassLoader) null));

        assertEquals(MyService.class,
                ClassLoaderUtil.loadServiceClass("com.ahwzsoft.unbiz.common.sample.MyService", "abc"));
    ...
    public void newInstance() throws Exception {
        ...
        try {
            ClassLoaderUtil.newInstance("com.ahwzsoft.unbiz.common.sample.MyErrorService");
        ...
        try {
            ClassLoaderUtil.newInstance("com.ahwzsoft.unbiz.common.sample.MyErrorService", getClass());
            fail("Expected ClassInstantiationException");
        } catch (ClassInstantiationException e) {
        }
        ...
        try {
            ClassLoaderUtil.newInstance("com.ahwzsoft.unbiz.common.sample.MyErrorService", getClass().getClassLoader());
            fail("Expected ClassInstantiationException");
        } catch (ClassInstantiationException e) {
        }
    }
    ...
    public void newServiceInstance() throws Exception {
        ...
        try {
            assertEquals(MyService.class, ClassLoaderUtil.newServiceInstance("com.ahwzsoft.unbiz.common.sample.MyService",
                    getClass().getClassLoader()));
            fail("expected ServiceNotFoundException");
        } catch (ServiceNotFoundException e) {
        }
        ...
        try {
            assertEquals(MyService.class,
                    ClassLoaderUtil.newServiceInstance("com.ahwzsoft.unbiz.common.sample.MyService", (ClassLoader) null));
            fail("expected ServiceNotFoundException");
        } catch (ServiceNotFoundException e) {
        }
    }
    ...
    public void newServiceInstance_ClassNameServiceId() throws Exception {
        ...
        assertInstance(MyService.class, ClassLoaderUtil.newServiceInstance("com.ahwzsoft.unbiz.common.sample.MyService",
                "com.ahwzsoft.unbiz.common.sample.MyService", getClass().getClassLoader()));
        assertInstance(MyService.class, ClassLoaderUtil.newServiceInstance("com.ahwzsoft.unbiz.common.sample.MyService",
                "com.ahwzsoft.unbiz.common.sample.MyService", (ClassLoader) null));

        assertInstance(MyService.class,
                ClassLoaderUtil.newServiceInstance("com.ahwzsoft.unbiz.common.sample.MyService", "abc"));
