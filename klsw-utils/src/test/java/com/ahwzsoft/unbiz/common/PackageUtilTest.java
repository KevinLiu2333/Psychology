 ...
 * 
 */
package com.ahwzsoft.unbiz.common;
...
import com.ahwzsoft.unbiz.common.CollectionUtil;
import com.ahwzsoft.unbiz.common.PackageUtil;
import com.ahwzsoft.unbiz.common.logger.CachedLogger;
...
public class PackageUtilTest extends CachedLogger {
    ...
    public void getClassesInPackage() throws IOException {
        ...
        assertNull(PackageUtil
                .getClassesInPackage(null, Arrays.asList(new String[] { "com.ahwzsoft.unbiz.common" }), null));
        assertNull(PackageUtil.getClassesInPackage("", Arrays.asList(new String[] { "com.ahwzsoft.unbiz.common" }), null));
        assertNull(PackageUtil.getClassesInPackage("     ", Arrays.asList(new String[] { "com.ahwzsoft.unbiz.common" }),
                null));

        assertTrue(CollectionUtil.isEmpty(PackageUtil.getClassesInPackage("com.ahwzsoft.beidou.xxx")));
        assertTrue(CollectionUtil.isEmpty(PackageUtil.getClassesInPackage("notexist")));

        List<String> utils = PackageUtil.getClassesInPackage("com.ahwzsoft.unbiz.common");
        assertTrue(CollectionUtil.isNotEmpty(utils));

        List<String> subUtils = PackageUtil.getClassesInPackage("com.ahwzsoft.unbiz.common.*");
        assertTrue(CollectionUtil.isNotEmpty(subUtils));
        assertTrue(CollectionUtil.isNotEmpty(utils));
        assertTrue(subUtils.size() > utils.size());
        assertTrue(subUtils.containsAll(utils));

        assertEquals(PackageUtil.getClassesInPackage("com.ahwzsoft.unbiz.common.*"),
                PackageUtil.getClassesInPackage("com.ahwzsoft.unbiz.common.*", null, null));
        assertEquals(PackageUtil.getClassesInPackage("com.ahwzsoft.unbiz.common.*"),
                PackageUtil.getClassesInPackage("com.ahwzsoft.unbiz.common.*", Arrays.asList(new String[] { ".*" }), null));

        assertTrue(CollectionUtil.isEmpty(PackageUtil.getClassesInPackage("com.ahwzsoft.unbiz.common.*",
                Arrays.asList(new String[] { ".*" }), Arrays.asList(new String[] { ".*" }))));
        assertTrue(CollectionUtil.isEmpty(PackageUtil.getClassesInPackage("com.ahwzsoft.unbiz.common.*", null,
                Arrays.asList(new String[] { ".*" }))));

        List<String> includeTests =
                PackageUtil.getClassesInPackage("com.ahwzsoft.unbiz.common.*", Arrays.asList(new String[] { ".*Test" }),
                        null);
        assertTrue(CollectionUtil.isNotEmpty(includeTests));
        List<String> excludeTests =
                PackageUtil.getClassesInPackage("com.ahwzsoft.unbiz.common.*", null,
    ...
    public void getResourceInPackage() throws IOException {
        ...
        assertTrue(CollectionUtil.isEmpty(PackageUtil.getResourceInPackage("com.ahwzsoft.beidou.xxx")));
        assertTrue(CollectionUtil.isEmpty(PackageUtil.getResourceInPackage("notexist")));
        List<String> utils = PackageUtil.getResourceInPackage("com.ahwzsoft.unbiz.common");
        assertTrue(CollectionUtil.isNotEmpty(utils));
        List<String> subUtils = PackageUtil.getResourceInPackage("com.ahwzsoft.unbiz.common.*");
        assertTrue(CollectionUtil.isNotEmpty(subUtils));
    ...
    public void getPackage() {
        ...
        assertEquals("com.ahwzsoft.unbiz.common", PackageUtil.getPackage(PackageUtil.class).getName());
