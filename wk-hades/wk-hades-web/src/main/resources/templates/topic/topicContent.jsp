    ...
    <div class="box-body">
    	<form class="form-horizontal">
            <div class="form-group">
                <div class="col-sm-1">
                    <button type="button" class="btn btn-success" onclick="addModel('${pageContext.request.contextPath}/topic/addConUI?id=${id}','添加专题页内容','460px','790px')">新增</button>
                </div>
            </div>
        </form>
...
var dtGridColumns = [{
    ...
    resolution : function(value, record, column, grid, dataNo, columnNo) {
        return '<a href="'+record.topicContentPicUrl+'" data-lightbox="activity_image"><img width="50px" height="50px" src="'+record.topicContentPicUrl+'" ></a>';
    }
}, {
    id : 'createDate',
    title : '创建时间',
    ...
    resolution : function(value, record, column, grid, dataNo, columnNo) {
        ...
        return '<button class="btn btn-sm btn-default" onclick="editModel('+record.id+',\'/topic/editConUI\',\'修改\',\'460px\',\'790px\')">修改</button>&nbsp;'+delHtml;
    }
}
];
...
var dtGridOption = {
    ...
    ajaxLoad : true,
    check : false,
    loadURL : sys.rootPath + '/topic/contentList?id=${id}',
