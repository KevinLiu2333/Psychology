...
<div class="box box-info">
	...
	<!-- /.box-header -->
	<!-- form start -->
	<form id="topicConForm" name="topicConForm" class="form-horizontal"
		...
		<div class="box-body">
			<div class="form-group">
       			 <label class="control-label col-sm-2 no-padding-right" for="description">专题描述</label>
       			 <div class="col-sm-10">
     		 ...
     		 <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="hidden" id="topicContentPicUrl" name='topicContentPicUrl'/>
                    <div id="imgs"><img style="width:50px; height:50px;padding-left:0px;" src="${content.topicContentPicUrl}"/></div><br/>
                    <div id="queue"></div>
		...
		<div class="box-footer">
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button id="btnAdd" type="button" onclick="commit('topicConForm','/topic/addCon');" class="btn btn-success btn-sm">
...
$('#file_upload').uploadify({  
   ...
   'onUploadSuccess' : function(file, data, response) { 
  	 ...
  	 if(response.status == '1'){
  		 ...
  		 $('#topicContentPicUrl').val(response.url);
