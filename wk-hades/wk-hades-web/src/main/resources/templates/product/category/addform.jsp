    ...
    <form id="categoryForm" name="categoryForm" class="form-horizontal" role="form" method="post"
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="clearfix">
                        <input class="form-control" name="categoryName" id="categoryName" type="text" placeholder="类别名称..."
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="clearfix">
                        <textarea class="form-control" name="categoryDesc" id="categoryDesc" rows="3" placeholder="类别描述..."></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="box-footer">
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button id="btnAdd" type="button" onclick="commit('categoryForm','/category/add');" class="btn btn-success btn-sm">
