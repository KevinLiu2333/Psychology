...
<div class="box box-info">
    ...
    <form id="categoryForm" name="categoryForm" class="form-horizontal" role="form" method="post"
        ...
        <input type="hidden" name="id" id="id" value="${merchantCategoryModel.id}">
        <div class="box-body">
            <div class="form-group">
                <label class="control-label col-sm-2 no-padding-right" for="categoryName">类别名称</label>
                <div class="col-sm-10">
                    <div class="clearfix">
                        <input class="form-control" name="name" value="${merchantCategoryModel.name}" id="name" type="text" placeholder="类别名称..."
            ...
            <div class="form-group">
                <label class="control-label col-sm-2 no-padding-right" for="categoryName">排序</label>
                <div class="col-sm-10">
                    <div class="clearfix">
                        <input class="form-control" style="width:300px;" name="sort" value="${merchantCategoryModel.sort}" id="sort" type="text" placeholder="排序值..."
                               data-fv-notempty="true"
                               data-fv-message="排序不能为空"/>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2 no-padding-right" for="logo_file_upload">logo</label>
                <div class="col-sm-10">
                    <input type="hidden" id="logo" name='logo' value="${merchantCategoryModel.logo}"/>
                     <div id="logo_imgs"><img src="${merchantCategoryModel.logo}" style="width:50px;height:50px;" /></div><br/>
                     <div id="logo_queue"></div>
                     <input id="logo_file_upload" name="logo_file_upload" class="form-control" type="file"  multiple="true">
                </div>
            </div>
             <div class="form-group">
                <label class="control-label col-sm-2 no-padding-right" for="pic_file_upload">大图</label>
                <div class="col-sm-10">
                    <input type="hidden" id="pic" name='pic' value="${merchantCategoryModel.pic}"/>
                     <div id="pic_imgs"><img src="${merchantCategoryModel.pic}" style="width:50px;height:50px;" /></div><br/>
        ...
        <div class="box-footer">
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button id="btnAdd" type="button" onclick="commit('categoryForm','/merchantCategory/save');" class="btn btn-success btn-sm">
...
$('#logo_file_upload').uploadify({  
   ...
   'uploader': '${pageContext.request.contextPath}/uploadPicServlet?tag=10', //服务器端脚本
   //修改formData数据  
