...
<div class="box box-info">
	...
	<form id="merchantForm" name="merchantForm" class="form-horizontal"
        ...
        <input type="hidden" name="id" value="${merchantInfoModel.id}"/>
			...
			<div class="row">
                <div class="col-md-6">
        			<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="merchant_name" id="merchant_name" type="text" placeholder="商铺名称..." value="${merchantInfoModel.merchant_name}"
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="contact" id="contact" type="text" placeholder="联系人真实姓名..." value="${merchantInfoModel.contact}"
							data-fv-notempty="true"
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="telephone" id="telephone" type="text" placeholder="联系电话..." value="${merchantInfoModel.telephone}"
							 data-fv-notempty="true"
						...
						<div class="col-sm-1">
							<select multiple="multiple" id="cityMerchantCategorieIds" name="cityMerchantCategorieIds" class="form-control" style="width:200px; height:100px;">
                                 <c:forEach items="${cityMerchantCategoryEntity}" var="val">
                                     <option value="${val.id}" <c:forEach items="${merchantInfoModel.cityMerchantCategorieList}" var="cl"><c:if test="${cl.id eq val.id }">selected=selected</c:if></c:forEach>>${val.categoryName}</option>
                                 </c:forEach>
                             </select>
						</div>
					</div>
						...
						<div class="col-sm-1">
							<select multiple="multiple" id="cityTopicIds" name="cityTopicIds" class="form-control" style="width:200px; height:100px;">
                                <c:forEach items="${cityTopicEntity}" var="val">
                                     <option value="${val.id}" <c:forEach items="${merchantInfoModel.cityTopicList}" var="cl"><c:if test="${cl.id eq val.id }">selected=selected</c:if></c:forEach>>${val.name}</option>
                                 </c:forEach>
                             </select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="shop_address" id="shop_address" type="text" style="width:400px;" readOnly="true" value="${merchantInfoModel.shop_address}"
							 data-fv-notempty="true"
					...
					<%-- <div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="opening_time" id="opening_time" type="text" value="${merchantInfoModel.opening_time}"
							 data-fv-notempty="true"
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="closing_time" id="closing_time" type="text" value="${merchantInfoModel.closing_time}"			 
							 data-fv-notempty="true"
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="work_time" id="work_time" type="text" placeholder="营业时间..." value="${merchantInfoModel.work_time}"
							 data-fv-notempty="true"
					...
					<%-- <div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="app_id" id="app_id" type="text" placeholder="APP ID..." value="${merchantInfoModel.app_id}" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-5 no-padding-right" for="app_secret">APP Secret</label>
						<div class="col-sm-6">
							<input class="form-control" name="app_secret" id="app_secret" type="text" placeholder="APP Secret (Live Mode)..." value="${merchantInfoModel.app_secret}"/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-5 no-padding-right" for="test_secret">Test Secret</label>
						<div class="col-sm-6">
							<input class="form-control" name="test_secret" id="test_secret" type="text" placeholder="Test Secret (Test Mode)..." value="${merchantInfoModel.test_secret}"/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-5 no-padding-right" for="master_secret">Master Secret</label>
						<div class="col-sm-6">
							<input class="form-control" name="master_secret" id="master_secret" type="text" placeholder="Master Secret..." value="${merchantInfoModel.master_secret}"/>
						</div>
					</div> --%>
					<div class="form-group">
		       			 <label class="control-label col-sm-5 no-padding-right" for="introduction">商铺描述</label>
		       			 <div class="col-sm-6">
		        		 	<input class="form-control" name="introduction" id="introduction" type="text" placeholder="商铺描述（15字以内）..." value="${merchantInfoModel.introduction}"
							 data-fv-notempty="true"
							 maxlength="15"
		     		 ...
		     		 <div class="form-group">
		       			 ...
		       			 <div class="col-sm-6" style="text-align:left; margin-top:8px;">
		        		 	<c:forEach items="${facilitieList}" var="val">
                                &nbsp;<label><input type="checkbox" name="facilities" value="${val.id}" 
                                	<c:forEach items="${selectedFacilities}" var="f">
                                		<c:if test="${val.id == f}">
                                			checked="checked"
                                		</c:if>
                                	</c:forEach>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div id="imgs"><a target="_blank" href="${merchantInfoModel.image_url}" data-lightbox="activity_image"><img style="width:50px; height=50px" src="${merchantInfoModel.image_url}" />&nbsp;</a></div><br/>
                            <div id="queue"></div>
...
$("#sure_btn").on('click',function(){
  ...
  $(function(){
	  ...
	  ue.ready(function(){
          UE.getEditor('UEcontainer').setContent('${merchantInfoModel.detail_html}',false);
      });
	  ...
	  $("#btnAdd").click(function(){
          ...
          commit("merchantForm","/merchant/edit");
      });
  });
