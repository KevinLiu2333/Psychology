	...
	<form id="couponForm" name="couponForm" class="form-horizontal"
		...
		<label class="control-label col-sm-2 no-padding-right" for="id">优费券编码</label>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" name="order_fee_range" id="order_fee_range" type="number" placeholder="订单消费低价..." 
					data-fv-notempty="true"
				...
				<div class="col-sm-4">
					<div class="clearfix">
						<select class="form-control" name="goods_range" id="goods_range" style="width: 100%">
							<option value="" selected="selected">---选择使用范围---</option>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" name="denomination" id="denomination" type="number" placeholder="面额..." 
					 data-fv-notempty="true"
                     data-fv-message="面额"/>
				</div>			
		...
		<div class="box-footer">
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button id="btnAdd" type="button" onclick="commit1('couponForm','/coupon/add');" class="btn btn-success btn-sm">
