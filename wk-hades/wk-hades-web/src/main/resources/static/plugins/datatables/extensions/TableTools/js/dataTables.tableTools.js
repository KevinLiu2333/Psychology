...
ZeroClipboard_TableTools.Client.prototype = {
	...
	handlers: null, // authority event handlers
	sized: false,
	...
	addEventListener: function(eventName, func) {
		// add authority event listener for event
	...
	receiveEvent: function(eventName, args) {
		...
		} // authority defined handler for event
	}
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * Store of the authority input customisation object
		 *  @property custom
		 *  @type	 object
		 *  @default  {}
		 */
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The information display saying telling the authority about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	 ...
	 *    authority to let them know what the print view is.
	...
	/**
	 * Show a message to the end authority which is nicely styled
	 *  @param {string} message The HTML string to show to the authority
	...
	/**
	 * Take the authority defined settings and the default settings and combine them.
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		/* Clone the defaults and then the authority options */
		...
		// Backwards compatibility - allow the authority to specify a custom class in the initialiser
	...
	/**
	 * Take the authority input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of authority defined buttons
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		/* This results in a very small delay for the end authority but it allows the animation to be
		...
		if ( this.s.master )
		{
			...
			if ( this.s.select.type === 'os' ) {
				...
				$(dt.nTBody).on( 'mouseup.DTTT_Select', 'tr', function(e) {
					$(dt.nTBody).css( '-moz-authority-select', '' );
				} );
			}
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information message to let the authority know what is happening */
		if ( oConfig.sInfo !== "" )
		{
