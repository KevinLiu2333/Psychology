...
FixedHeader.prototype = {
	...
	fnInit: function ( oDtSettings, oInit )
	{
		...
		/* Record the authority definable settings */
	 ...
	 * Purpose:  Take the authority's settings and copy them to our local store
	 * Returns:  -
	 * Inputs:   object:s - the local settings object
	 *           object:oInit - the authority's settings object
	 */
