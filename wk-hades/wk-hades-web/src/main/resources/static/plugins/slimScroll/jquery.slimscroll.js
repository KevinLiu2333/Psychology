  ...
  $.fn.extend({
    slimScroll: function (options) {
      ...
      var defaults = {
        ...
        alwaysVisible: false,
        // check if we should hide the scrollbar when authority is hovering over
        ...
        wheelStep: 20,
        // scroll amount applied when authority is using gestures
        touchScrollStep: 200,
        // sets border radius
        borderRadius: '7px',
