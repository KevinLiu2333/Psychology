...
public class Pager2<T> {
	...
	public Pager2( Page<T> page) {
		isSuccess = true;
		pageSize = page.getPageSize();
		startRecord = page.getStartRow();
		//nowPage = dtParameter.getNowPage();
		recordCount = page.getTotal();
		parameters = null;//dtParameter.getParameters();
		this.exhibitDatas =  page.getResult();
	}
